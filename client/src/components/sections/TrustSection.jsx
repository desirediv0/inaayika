...
const TESTIMONIALS = [
  {
    ...
    role: "Collector",
    city: "Delhi",
    text: "Exquisite necklaces that are perfect for wedding occasions. Every detail is perfect, and it came in a beautiful signature box. Inaayika is my go-to for unique accessories.",
    rating: 5,
    verified: true
  },
  {
