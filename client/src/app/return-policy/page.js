...
export const metadata = {
    title: "Return & Cancellation Policy | Inaayika",
    description: "Review Inaayika's handcrafted jewellery return guidelines, customized item restrictions, refund approvals, and replacement terms.",
};
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="rounded-3xl p-8 md:p-12 border shadow-sm space-y-10" style={{ background: "#FDFBF7", borderColor: "#E9E2D5" }}>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3 pl-5 list-disc text-xs md:text-sm text-slate-600">
                                <li>Please take high-resolution photos of the package and immediately contact us at **Inaayikabypoojakhan@gmail.com** or WhatsApp (+91 87964 49692) within **24 hours** of delivery.</li>
