...
export const metadata = {
    ...
    description: "Read Inaayika's Terms of Use, customised order policies, and secure purchasing agreements in compliance with Razorpay standards.",
};
                    ...
                    <div className="bg-white rounded-3xl p-8 md:p-12 border border-[#E5E7EB] shadow-sm space-y-10">
                        ...
                        <div>
                            ...
                            <p className="text-slate-600 text-sm leading-relaxed">
                                By visiting Inaayika, registering an account, purchasing items, submitting design queries, or confirming customised orders, you explicitly accept these Terms and Conditions. These terms govern your use of the website and constitute a binding legal agreement between you and Inaayika. If you do not agree to these terms, please do not use the platform.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-slate-600 text-sm leading-relaxed mb-3">
                                Online transactions on Inaayika are processed using the secure Razorpay payment gateway:
                            </p>
                            <ul className="space-y-2 pl-5 list-disc text-xs md:text-sm text-slate-600">
