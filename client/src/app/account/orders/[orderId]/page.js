            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
                <div>
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h1 className="text-2xl md:text-3xl  ">Order #{order.orderNumber}</h1>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div className="p-6 space-y-3">
                            ...
                            <div className="border-t border-gray-100 pt-3 mt-3 flex justify-between font-semibold text-lg">
                                 <span>Total</span>
                                 <span className="text-[#003E29]">{formatCurrency(order.total)}</span>
                             </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        <Link href="/products">
                            <Button className="w-full bg-[#003E29] hover:bg-[#002216] text-white border border-[#D4AF37]/20">
                                <DynamicIcon name="ShoppingBag" className="mr-2 h-4 w-4 text-[#D4AF37]" /> Continue Shopping
                            </Button>
                        </Link>
                    </div>
                </div>
