...
export const metadata = {
  ...
  description: "Learn about Inaayika's premium packaging, global shipping options, delivery timelines, and transit protocols for handcrafted jewellery.",
};
            ...
            <div>
              ...
              >
                ...
                <p className="text-xs text-gray-600 leading-relaxed">
                  In order to maintain quick processing timelines and safety, **Inaayika does not offer Cash on Delivery (COD)**. All orders must be prepaid online via our secure payment gateway.
                </p>
              </div>
            </div>
