        ...
        <div className="w-full max-w-md space-y-8 relative z-10">
          ...
          <div className="space-y-3">
            <h1 className="text-4xl lg:text-5xl   text-white leading-tight    tracking-tight">
              Inaayika <span className="text-[#D4AF37]">Admin Portal</span>
            </h1>
            <p className="text-zinc-400 text-sm">
              Enter your credentials to manage your premium handcrafted collections, orders, and clients
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  id="email"
                  type="email"
                  placeholder="admin@inaayika.com"
                  value={email}
                  ...
                  required
                  className={`w-full h-12 px-4 bg-zinc-950/50 backdrop-blur-sm border rounded-lg text-white placeholder-zinc-700 
                    transition-all duration-200
                    ${focusedField === "email"
                      ? "border-[#D4AF37] shadow-[0_0_0_3px_rgba(212,175,55,0.1)]"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ...
                  disabled={isSubmitting}
                  required
                  className={`w-full h-12 px-4 pr-20 bg-zinc-950/50 backdrop-blur-sm border rounded-lg text-white placeholder-zinc-700 
                    transition-all duration-200
            ...
            <Button
              type="submit"
              className="w-full h-12 text-sm   bg-[#003E29] hover:bg-[#002b1c] 
                border border-[#003E29] hover:border-[#002b1c] 
